        ...
        <div id="left">
			...
			<tr>
				...
				<input type="number" value="0" min="0" max=<?php
                            ...
                            $sql = "SELECT quantity FROM Products WHERE product_name = 'chleb_pszenny'";
				...
				<td><h2>
                    ...
                    <?php
                            ...
                            $sql = "SELECT price FROM Products WHERE product_name = 'chleb_pszenny'";
                            $result = $conn->query($sql);
                    ...
                    ?>zł/<?php
                            ...
                            $sql = "SELECT unit FROM Products WHERE product_name = 'chleb_pszenny'";
                            $result = $conn->query($sql);
			...
			<tr>
				<td colspan="2">
				<button type="button" onclick="dodaj('chleb_pszenny', document.getElementById('input').value)">Dodaj</button>
				</td>
			</tr>
		</table>
                </div>
