...
<body>
    <div id="main" a href>
        ...
        <div id="left">
			...
			<tr>
				<td rowspan="3"><img src="images/sok_jablkowy.jpg" width=400px></td>
				<td>
				...
				<input type="number" value="0" min="0" max=<?php
                            ...
                            $sql = "SELECT quantity FROM Products WHERE product_name = 'sok_jablkowy'";
				...
				<td><h2>
                    ...
                    <?php
                            ...
                            $sql = "SELECT price FROM Products WHERE product_name = 'sok_jablkowy'";
                            $result = $conn->query($sql);
                    ...
                    ?>zł/<?php
                            ...
                            $sql = "SELECT unit FROM Products WHERE product_name = 'sok_jablkowy'";
                            $result = $conn->query($sql);
			...
			<tr>
				<td colspan="2">
				<button type="button" onclick="dodaj('sok_jablkowy', document.getElementById('input').value)">Dodaj</button>
				</td>
			</tr>
		</table>
                </div>
